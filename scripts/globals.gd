...
func _on_game_state_changed(new_state: GameState, _old_state: GameState):
    match new_state:
...
func _on_player_state_changed(new_state: Player.PlayerState, _old_state: Player.PlayerState):
    match new_state:
